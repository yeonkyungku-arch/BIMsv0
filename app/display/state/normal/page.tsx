...
export default function DisplayNormalPreviewPage({
  searchParams,
}: {
  ...
  return (
    <DisplayFrame deviceId={deviceId}>
      {deviceId && (
        <div className="absolute top-6 right-6 border-2 border-black px-3 py-1 text-lg font-semibold tabular-nums">
          ID: {deviceId}
        </div>
      )}
